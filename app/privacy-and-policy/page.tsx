...
export const metadata: Metadata = {
  ...
  description:
    "Learn how New Market protects your privacy and personal data. Our comprehensive privacy policy covers data collection, usage, security measures, user rights, and cookie policies.",
  keywords: [
    "privacy policy",
    "data protection",
    "user privacy",
  ...
  openGraph: {
    ...
    title: "Privacy Policy - New Market | Data Protection & User Rights",
    description:
      "Learn how New Market protects your privacy and personal data. Comprehensive privacy policy covering data collection, usage, and security.",
    siteName: "New Market",
  },
  twitter: {
...
export default function PrivacyAndPolicyPage() {
  const dataTypes = [
    ...
    },
    {
      ...
      description:
        "Credit card details, billing information (processed securely by third-party providers)",
      icon: Lock,
    ...
    },
    {
      category: "Usage Data",
      description:
        "Browsing behavior, search queries, product preferences, and interaction patterns",
      icon: Eye,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="text-muted-foreground mx-auto mb-8 max-w-3xl text-xl leading-relaxed">
            ...
            collect, use, and safeguard your data when you use New Market.
          </p>
        ...
        <div className="mb-12">
          <Alert>
            ...
            <AlertDescription className="text-base">
              <strong>Quick Summary:</strong> We collect only necessary
              information to provide our services, never sell your data to third
              parties, and give you full control over your privacy settings.
            </AlertDescription>
          </Alert>
        </div>
        ...
        <div className="mb-16">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl">
              ...
              users. Here's what we collect and why.
            </p>
          </div>
        ...
        <div className="mb-16">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl">
              You have full control over your personal information. Here are the
        ...
        <div className="mb-16">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground mx-auto max-w-2xl">
              ...
              personalized services. You can control cookie settings in your
              browser.
            </p>
          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                ...
                provide our services and comply with legal obligations. Here are
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Kept for 7 years to comply with financial regulations and
                    tax requirements.
                  </p>
                </div>
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Deleted immediately upon unsubscribe or after 2 years of
                    inactivity.
                  </p>
                </div>
                <div className="rounded-lg border p-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Anonymized after 26 months and used only for statistical
                    purposes.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    policy from time to time. We'll notify you of any
